...
// Chart 1: Performance Score (Line Chart)
...
// Chart 2: Task Completion Rate (Bar Chart)
...
// Chart 3: Time Distribution (Doughnut Chart)
...
function updateCharts(newData) {
    ...
    // Update Task Chart
    if (newData.tasks) {
        taskChart.data.datasets[0].data = newData.tasks;
        taskChart.update();
    }
    
    // Update Time Chart
    if (newData.timeDistribution) {
        timeChart.data.datasets[0].data = newData.timeDistribution;
        timeChart.update();
    }
}
